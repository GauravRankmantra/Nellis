      ...
      <div className="bg-gradient-to-r from-blue-900 via-slate-900 to-green-900 text-white py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="flex items-center space-x-4">
            <h1 className="text-5xl font-bold">{dealer.name}</h1>
            ...
            <div className="bg-white rounded-2xl shadow-lg overflow-hidden">
              ...
              <div className="p-8">
                <div className="flex justify-between items-start mb-6">
                  <div>
                    <h2 className="text-3xl font-bold mb-3 text-gray-900">{dealer.name}</h2>
                ...
                <p className="text-gray-700 text-xl leading-relaxed">{dealer.description}</p>
              </div>
            </div>
              ...
              <div className="space-y-6">
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600 text-lg">{dealer.address}</p>
                  </div>
                </div>
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <a href={`tel:${dealer.phone}`} className="text-blue-600 hover:text-blue-800 text-lg font-medium transition-colors duration-300">
                      {dealer.phone}
                    </a>
                  </div>
                </div>
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <a href={`mailto:${dealer.email}`} className="text-blue-600 hover:text-blue-800 text-lg font-medium transition-colors duration-300">
                      {dealer.email}
                    </a>
                  </div>
                </div>
                <div className="flex items-start">
                  ...
                  <div>
                    ...
                    <a href={`https://${dealer.website}`} className="text-blue-600 hover:text-blue-800 text-lg font-medium transition-colors duration-300" target="_blank" rel="noopener noreferrer">
                      {dealer.website}
                    </a>
                  </div>
                </div>
            ...
            <div className="bg-white rounded-2xl shadow-lg p-8">
              ...
              <div className="bg-gradient-to-br from-blue-50 to-green-50 h-64 rounded-2xl flex items-center justify-center border-2 border-blue-200">
                <div className="text-center">
                  ...
                  <p className="text-gray-500 mt-2">{dealer.address}</p>
                </div>
              </div>
            </div>
          </div>
