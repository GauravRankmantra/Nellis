...
import { Car, Shield, DollarSign, Clock, Star, ArrowRight, Users, Award, CheckCircle } from 'lucide-react';
    ...
    <div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
              We're your trusted partner for quality used vehicles along Las Vegas' premier auto corridor.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="group text-center p-8 bg-white rounded-2xl hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 border border-gray-100">
              ...
              <h3 className="text-xl font-semibold mb-4 text-gray-900">Quality Vehicles</h3>
              <p className="text-gray-600 leading-relaxed">Thoroughly inspected, low-mileage cars from trusted dealerships with detailed history reports</p>
            </div>
            ...
            <div className="group text-center p-8 bg-white rounded-2xl hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 border border-gray-100">
              ...
              <h3 className="text-xl font-semibold mb-4 text-gray-900">Warranty Protection</h3>
              <p className="text-gray-600 leading-relaxed">Extended warranties and comprehensive service protection plans available for peace of mind</p>
            </div>
            ...
            <div className="group text-center p-8 bg-white rounded-2xl hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 border border-gray-100">
              ...
              <h3 className="text-xl font-semibold mb-4 text-gray-900">Competitive Pricing</h3>
              <p className="text-gray-600 leading-relaxed">Best prices on Nellis Boulevard with flexible financing options and trade-in programs</p>
            </div>
            ...
            <div className="group text-center p-8 bg-white rounded-2xl hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 border border-gray-100">
              ...
              <h3 className="text-xl font-semibold mb-4 text-gray-900">Quick Service</h3>
              <p className="text-gray-600 leading-relaxed">Fast approvals and same-day delivery when possible with streamlined processes</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-gradient-to-r from-blue-900 via-slate-900 to-blue-900 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-blue-200">Our numbers speak for themselves</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
            <div className="group bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2">
              ...
              <div className="p-8">
                ...
                <p className="text-gray-600 mb-4 leading-relaxed">Family-owned dealership with 20+ years of experience serving Las Vegas</p>
            ...
            <div className="group bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2">
              ...
              <div className="p-8">
                ...
                <p className="text-gray-600 mb-4 leading-relaxed">Proud to serve military families with honor and exceptional service</p>
                <div className="flex items-center mb-6">
                  <div className="flex text-yellow-400">
                    {[...Array(5)].map((_, i) => (
                      <Star key={i} className="h-5 w-5 fill-current" />
            ...
            <div className="group bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2">
              ...
              <div className="p-8">
                ...
                <p className="text-gray-600 mb-4 leading-relaxed">Flexible financing for all credit situations and first-time buyers</p>
                <div className="flex items-center mb-6">
                  <div className="flex text-yellow-400">
                    {[...Array(4)].map((_, i) => (
                      <Star key={i} className="h-5 w-5 fill-current" />
            ...
            <div className="bg-gray-50 rounded-2xl p-8 border border-gray-100">
              ...
              <div className="flex items-center">
                ...
                <div className="ml-4">
                  ...
                  <div className="text-gray-600 text-sm">North Las Vegas, NV</div>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="py-20 bg-gradient-to-r from-blue-900 via-slate-900 to-red-900 text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-4xl md:text-5xl font-bold mb-6">Ready to Find Your Next Vehicle?</h2>
          <p className="text-xl md:text-2xl text-gray-200 mb-10 max-w-3xl mx-auto leading-relaxed">
            Browse our extensive inventory of quality pre-owned vehicles or get pre-approved for financing today.
          </p>
